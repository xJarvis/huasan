...
//getHash gets the crypto exhash type & hashed data in different exhash type
...
//GetHashFunc gets the crypto exhash func & type in different exhash type
...
//ParsePrivateKey parses private key bytes to exrsa privateKey
